...
class CloudinaryWrapperTest extends \PHPUnit\Framework\TestCase
{
    public function setUp(): void
    {
        $this->config = mock('Illuminate\Config\Repository');
        $this->cloudinary = mock('Cloudinary');
        $this->uploader = mock('Cloudinary\Uploader');
        $this->api = mock('Cloudinary\Api');
